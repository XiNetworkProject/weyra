      ...
      <section className={styles.intro}>
        ...
        <div className={styles.features}>
          <span>
            <IconCompass />
            <b>Atlas personnel</b>
            <small>Lieux, alertes et carnet synchronisés</small>
          </span>
          <span>
            <IconCloudRain />
            <b>Observations utiles</b>
            <small>Signaux terrain horodatés et modérés</small>
          </span>
          <span>
            <IconUsers />
            <b>Communautés locales</b>
            <small>Espaces organisés autour d&apos;un territoire</small>
          </span>
        </div>
      </section>
